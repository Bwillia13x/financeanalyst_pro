    ...
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 rounded border bg-white">
          ...
          <ul className="text-sm space-y-1">
            <li>
              VITE_ENABLE_ANALYTICS: <b>{String(env.VITE_ENABLE_ANALYTICS)}</b>
            </li>
            <li>
              VITE_ENABLE_ERROR_REPORTING: <b>{String(env.VITE_ENABLE_ERROR_REPORTING)}</b>
            </li>
            <li>
              VITE_PERFORMANCE_MONITORING: <b>{String(env.VITE_PERFORMANCE_MONITORING)}</b>
            </li>
            <li>
              GA_TRACKING_ID: <b>{env.VITE_GA_TRACKING_ID || 'MISSING'}</b>
            </li>
            <li>
              HOTJAR_ID: <b>{env.VITE_HOTJAR_ID || 'MISSING'}</b>
            </li>
            <li>
              SENTRY_DSN: <b>{env.VITE_SENTRY_DSN}</b>
            </li>
          </ul>
        </div>
      ...
      <div className="mt-6 text-sm text-neutral-600">
        ...
        <ul className="list-disc ml-6 mt-2 space-y-1">
          ...
          <li>
            Look for WebSocket to <code>wss://*.hotjar.com</code> and requests to{' '}
            <code>in.hotjar.com</code>.
          </li>
