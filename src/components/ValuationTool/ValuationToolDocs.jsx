  ...
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold text-foreground mb-4">Business Valuation Guide</h1>
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">What is DCF?</h3>
                <p className="text-foreground-secondary leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">Key Components</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-accent/10 p-4 rounded-lg">
                    <h4 className="font-semibold text-accent mb-2">Free Cash Flow Projections</h4>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                    ...
                    <span className="text-sm text-foreground-secondary">Starting point for projections</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                    <span className="font-medium">Revenue Growth Rate</span>
                    <span className="text-sm text-foreground-secondary">Annual growth assumption</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                    <span className="font-medium">EBITDA Margin</span>
                    <span className="text-sm text-foreground-secondary">Profitability assumption</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                    <span className="font-medium">Discount Rate</span>
                    <span className="text-sm text-foreground-secondary">Risk-adjusted return requirement</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                    <span className="font-medium">Terminal Growth Rate</span>
                    <span className="text-sm text-foreground-secondary">Long-term growth assumption</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">What is LBO?</h3>
                <p className="text-foreground-secondary leading-relaxed">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-accent/10 p-4 rounded-lg">
                    <h4 className="font-semibold text-accent mb-2">Equity Investment</h4>
                    <p className="text-sm text-accent/90">
                      Amount of equity capital invested in the transaction
                    </p>
                  </div>
                  <div className="bg-success/10 p-4 rounded-lg">
                    <h4 className="font-semibold text-success mb-2">Debt Financing</h4>
                    <p className="text-sm text-success/90">
                      Leverage used to finance the acquisition
                    </p>
                  </div>
                  <div className="bg-accent/10 p-4 rounded-lg">
                    <h4 className="font-semibold text-accent mb-2">Exit Value</h4>
                    <p className="text-sm text-accent/90">
                      Expected value at exit based on EBITDA multiple
                    </p>
                  </div>
                  <div className="bg-warning/10 p-4 rounded-lg">
                    <h4 className="font-semibold text-warning mb-2">IRR & MOIC</h4>
                    <p className="text-sm text-warning/90">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                    ...
                    <span className="text-sm text-foreground-secondary">Total acquisition cost</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                    <span className="font-medium">Equity Contribution</span>
                    <span className="text-sm text-foreground-secondary">Percentage of equity vs debt</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                    <span className="font-medium">Exit Multiple</span>
                    <span className="text-sm text-foreground-secondary">EBITDA multiple at exit</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                    <span className="font-medium">Exit Year</span>
                    <span className="text-sm text-foreground-secondary">Holding period</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                    <span className="font-medium">EBITDA Growth</span>
                    <span className="text-sm text-foreground-secondary">Operational improvement</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">DCF Best Practices</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">LBO Best Practices</h3>
                <ul className="space-y-2 text-foreground-secondary">
                  <li className="flex items-start">
          ...
          <motion.div
            ...
            className="bg-card rounded-xl shadow-lg p-6 border border-border"
          >
            <h2 className="text-2xl font-bold text-foreground mb-4">Industry Benchmarks</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">Typical Discount Rates</h3>
