    ...
    steps: [
      {
        ...
        content:
          'Start by building your financial model with historical and projected data. Click here to access the spreadsheet interface.',
      ...
      },
      {
        ...
        content:
          'Begin with revenue projections. Break down by business segments or product lines for more accurate modeling.',
      ...
      },
      {
        ...
        content:
          'Model your cost structure including COGS, SG&A, and other operating expenses. Link these to revenue drivers where possible.',
      ...
      },
      {
        ...
        content:
          'Access DCF, LBO, and other valuation models. These tools use your spreadsheet data for sophisticated analysis.',
      ...
      },
      {
        ...
        content:
          'View detailed results including valuations, ratios, and sensitivity analysis. Export reports for presentations.',
    ...
    steps: [
      {
        ...
        content:
          'Set your growth rates, margin assumptions, and terminal value parameters. These drive your entire valuation.',
      ...
      },
      {
        ...
        content:
          'Configure your weighted average cost of capital. This discount rate reflects the risk of your investment.',
      ...
      },
      {
        ...
        content:
          'Review projected free cash flows. These should reflect your operating assumptions and capital requirements.',
      ...
      },
      {
        ...
        content:
          'The terminal value often represents 60-80% of total value. Choose appropriate growth rates and exit multiples.',
      ...
      },
      {
        ...
        content:
          'Test how changes in key assumptions affect valuation. This helps assess investment risk.',
    ...
    steps: [
      {
        ...
        content:
          'Get a high-level view of your portfolio performance, allocation, and key metrics.',
      ...
      },
      {
        ...
        content:
          'Detailed view of individual positions with performance metrics, valuations, and risk indicators.',
      ...
      },
      {
        ...
        content:
          'Visualize your portfolio allocation by sector, geography, market cap, or custom categories.',
      ...
      },
      {
        ...
        content:
          'Track performance over time with benchmark comparisons and risk-adjusted metrics.',
    ...
    steps: [
      {
        ...
        content:
          'Real-time market data, indices, and key economic indicators to inform your analysis.',
      ...
      },
      {
        ...
        content:
          'Search and analyze public companies with financial statements, ratios, and peer comparisons.',
      ...
      },
      {
        ...
        content:
          'Access key economic data like GDP, inflation, interest rates, and employment statistics.',
...
export const FEATURE_INTRODUCTIONS = {
  financialValidator: {
    ...
    content:
      'Get instant feedback on your financial inputs with suggestions for improvements and error detection.',
  ...
  virtualizedTable: {
    ...
    content:
      'Handle large datasets efficiently with our virtualized table system. Scroll through thousands of rows without performance issues.',
  ...
  advancedCharts: {
    ...
    content:
      'Create professional charts and visualizations. Click chart types to switch views and hover for detailed information.',
  ...
  exportCapabilities: {
    ...
    content:
      'Export your analysis to Excel, PDF, or CSV formats. Perfect for presentations and further analysis.',
